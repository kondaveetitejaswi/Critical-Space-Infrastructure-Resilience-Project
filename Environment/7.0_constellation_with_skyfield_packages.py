# the version where the plotting uses the summarized plots for all the episodes
import numpy as np
...
class SkyfieldADPSolver:
    ...
    def run_adp_training(self, initial_state, episodes=200, steps_per_episode=150, output_dir="."):
        ...
        with open(csv_path, 'w', newline='', encoding='utf-8-sig') as f:
            ...
            for ep in range(1, episodes + 1):
                ...
                decay_at_step = episodes // 2
                eps = max(0.05, 0.40 - (min(ep, decay_at_step) / decay_at_step) * 0.35)
    ...
    def _generate_plots(self, output_dir):
        ...
        roll_r = np.convolve(rewards, np.ones(10)/10, mode='same') # 10-episode rolling average
...
if __name__ == "__main__":
    ...
    adp.run_adp_training(initial_state, episodes=200, steps_per_episode=150, output_dir=OUTPUT_DIR)
